---
name: content-atoms
description: Extract reusable content atoms from any source material. Use when ingesting transcripts, notes, URLs, or voice memos. Each atom is typed, GRIP-scored, and mapped to audiences.
user-invocable: true
model: sonnet
---
...
Example: "The GRIP framework: Gravity, Reach, Impact, Proof - score every piece before posting."
...
3. Label type, GRIP primary pillar, target audience, awareness stage, strength (0-1)
