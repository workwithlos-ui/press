...
description: PROACTIVELY invoke for any competitive research, market analysis, competitor monitoring, or industry intelligence. Fetches live competitor data, identifies content gaps, and surfaces strategic opportunities. Use when asked about competitors, market positioning, or industry trends.
...
2. Read their pricing page, features, and positioning
3. Check recent news, product launches, reviews (WebSearch)
4. Identify: what they lead with, what they avoid, where buyers complain
5. Map the gap: what do buyers want that competitors don't deliver?

## OUTPUT FORMAT FOR COMPETITOR ANALYSIS
- Positioning: What they lead with (1-2 sentences)
- 4 content/feature strengths
- 4 specific weaknesses or gaps
- 5 content gaps to exploit
- 5 content briefs to outperform them (title + angle + platform + why it wins)
...
Find these from: G2 reviews, Reddit complaints, Twitter/X frustrations, Trustpilot.
